...
tworzących kompletne środowisko serwera aplikacji WWW. Oprócz serwera
...
%description xml-devel -l pl.UTF-8
...
%description xml-tools -l pl.UTF-8
...
Podstawowe biblioteki SOPE zawierają:

- różne rozszerzenia Foundation
- bibliotekę strumieni i gniazd podobną do java.io
...
będących częścią szkieletu serwera aplikacji SOPE.
...
%description mime -l pl.UTF-8
Biblioteki SOPE do przetwarzania MIME zawierają:

- klasy do przetwarzania jednostek MIME
- pełną implementację IMAP4
...
%description mime-devel -l pl.UTF-8
...
%description appserver -l pl.UTF-8
Biblioteki serwera aplikacji SOPE udostępniają:

- silnik renderujący szablony i wiele elementów dynamicznych
- klienta/serwer HTTP
- klienta XML-RPC
- szkielet serwera WebDAV
- zarządzanie sesjami
- rozszerzenia skryptowe dla Foundation oraz pomost dla JavaScriptu
- bibliotekę renderującą drzewa DOM
...
%description appserver-devel -l pl.UTF-8
...
%description appserver-tools -l pl.UTF-8
Ten pakiet zawiera narzędzia dostarczane ze szkieletem serwera
aplikacji SOPE, przydatne głównie do rozwijania i śledzenia aplikacji
SOPE.
...
Biblioteki SOPE do dostępu do LDAP zawierają wrapper Objective-C dla
usług katalogowych LDAP.
...
%description ldap-devel -l pl.UTF-8
...
%description ldap-tools -l pl.UTF-8
Ten pakiet zawiera następujące narzędzia:
...
%description ical -l pl.UTF-8
Biblioteki SOPE do obsługi iCal zawierają klasy dla obiektów iCalendar
i vCard.
...
%description ical-devel -l pl.UTF-8
...
%description gdl1 -l pl.UTF-8
Ten pakiet zawiera odgałęzienie bibliotek GNUstepa do baz danych
używane przez serwer aplikacji SOPE (wraz z GDLContentStore).
...
%description gdl1-postgresql -l pl.UTF-8
Ten pakiet zawiera moduł PostgreSQL dla odgałęzienia SOPE bibliotek do
baz danych GNUstepa.
...
%description gdl1-mysql -l pl.UTF-8
Ten pakiet zawiera moduł MySQL dla odgałęzienia SOPE bibliotek do baz
danych GNUstepa.

#%package gdl1-sqlite3
#Summary:	SQLite3 connector for SOPE's fork of the GNUstep database environment
#Summary(pl):	Moduł SQLite3 dla odgałęzienia SOPE środowiska baz danych GNUstepa
#Group:		Libraries
#Requires:	%{name}-gdl1 = %{version}-%{release}
#
...
#Ten pakiet zawiera moduł SQLite3 dla odgałęzienia SOPE bibliotek do baz
#danych GNUstepa.
...
%description gdl1-tools -l pl.UTF-8
Różne narzędzia dla GDLContentStore.
...
%description gdl1-devel -l pl.UTF-8
Ten pakiet zawiera pliki nagłówkowe dla odgałęzienia SOPE bibliotek do
baz danych GNUstepa (włącznie z GDLContentStore).
